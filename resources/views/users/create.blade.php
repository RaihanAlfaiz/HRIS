    ...
    <div class="max-w-2xl mx-auto">
        <div class="rounded-2xl bg-white shadow-sm border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-primary-600 to-indigo-600 px-6 py-5">
                ...
                <p class="text-primary-200 text-sm mt-0.5">Isi data di bawah untuk membuat akun login baru</p>
            </div>
            ...
            <form method="POST" action="{{ route('users.store') }}" class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="role" value="{{ $val }}" class="peer sr-only" {{ old('role', 'viewer') === $val ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Pilih karyawan yang belum punya akun. Digunakan untuk fitur absensi mandiri.</p>
                </div>
