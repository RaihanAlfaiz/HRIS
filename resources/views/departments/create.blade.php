<x-layouts.app :title="'Tambah Departemen'">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <form method="POST" action="{{ route('departments.store') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="rounded-xl bg-primary-600 px-6 py-2.5 text-sm font-medium text-white shadow-sm shadow-primary-600/25 transition hover:bg-primary-700 active:scale-[0.98]">Simpan</button>
                </div>
            </form>
        </div>
    </div>
